 ...
 * @param {number} autoClose - Auto-close delay in ms (0 = disabled)
...
const Alert = ({
  ...
  const typeStyles = {
    ...
    error: {
      ...
      button: 'text-danger-400 hover:text-danger-600',
    },
    warning: {
    ...
    info: {
      ...
      icon: 'text-info-600',
      text: 'text-info-800',
      button: 'text-info-400 hover:text-info-600',
    },
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex-1">
        {message && <div className={`${styles.text} font-medium`}>{message}</div>}
        {children && <div className={`${styles.text} text-sm mt-1`}>{children}</div>}
      </div>
